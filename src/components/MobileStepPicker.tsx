      ...
      <div className="px-4 py-6 space-y-4">
        ...
        <div className="space-y-3">
          ...
          >
            <div className="flex-shrink-0">
              <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
                selectedMethod === 'csv' ? 'bg-primary' : 'bg-secondary'
              }`}>
                {selectedMethod === 'csv' ? (
          ...
          >
            <div className="flex-shrink-0">
              <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
                selectedMethod === 'manual' ? 'bg-primary' : 'bg-secondary'
              }`}>
                {selectedMethod === 'manual' ? (
                  <Check className="w-5 h-5 text-primary-foreground" />
                ) : (
        ...
        {selectedMethod === 'csv' && (
          <div 
            ref={csvSectionRef}
            className="bg-card rounded-xl border border-border p-4 space-y-3 animate-fadeIn shadow-sm"
          >
                ...
                <div className="p-3 bg-green-500/10 border border-green-500/20 rounded-lg">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-green-700 dark:text-green-400 font-medium">File uploaded: {csvFile.name}</span>
                    </div>
                    <button
                  ...
                  <div className="mt-2">
                    <button
                      ...
                      className="text-green-700 dark:text-green-400 text-sm hover:text-green-800 dark:hover:text-green-300 transition-colors underline"
                    >
                      Change file
                    </button>
                  </div>
...
Beta LLC,Mobile App,2024-01-17,4.0,Development,TRUE`;
        ...
        {selectedMethod === 'manual' && (
          <div className="bg-card rounded-xl border border-border p-4 animate-fadeIn shadow-sm">
        ...
        {showCompare && (
          <div className="fixed inset-0 bg-black/50 z-50 flex items-end">
            <div className="bg-card rounded-t-xl w-full max-h-[60vh] overflow-hidden shadow-lg">
      ...
      {/* Sticky CTA */}
      <div className="fixed inset-x-0 bottom-0 p-4 bg-card/90 backdrop-blur supports-[backdrop-filter]:backdrop-blur border-t border-border lg:hidden shadow-lg" style={{ paddingBottom: 'calc(1rem + env(safe-area-inset-bottom))' }}>
        <button
